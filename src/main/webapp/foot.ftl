    	...
    	<div class="web_center clearfix">
    			<#list systemManager().newsCatalogs as item>
					<div class="web_box">
						...
						<#if item.news??>
						    <#list item.news as item>
						    	<span><a href="${basepath}/help/${item.code}.html" target="_blank"> ${item.title!""}</a></span>
							</#list>
						</#if>
					</div>
				</#list>
...
<script>
	...
	(function() {
	  ...
	  hm.src = "//hm.baidu.com/hm.js?b334d744c361a4ca09eb6c7f7523e3a4";
