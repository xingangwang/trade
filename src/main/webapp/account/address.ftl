...
.centerImageCss{
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-3" style="padding:0; width:210px;margin-left: -20px;">
				...
				<div class="row">
					<form role="form" id="form" class="form-horizontal" method="post" action="saveAddress" theme="simple">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-lg-3">
                            <select class="form-control" id="areaSelect" name="area" data-rule="收货地址:required">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-lg-6">
						    ...
						    class="form-control" id="phone" data-rule="length[0~15];phone;" placeholder="请输入收货人座机号码" maxlength="15"/>
					    </div>
					  </div>
					  <div class="form-group">
