			...
			<div class="col-md-7">
				...
				<div class="panel panel-success">
		              ...
		              <div class="panel-footer">
		              	<span id="qqLoginBtn" title="使用QQ号登录"></span>
						<span id="wb_connect_btn" title="使用新浪微博号登录"></span>
						<span>
							<a href="alipayFastLogin.html" title="使用支付宝快捷登录">
	<%-- 							<img src="<%=SystemManager.systemSetting.getWww() %>/resource/images/alipay.gif" alt="支付宝快捷登录"> --%>
								<img src="<%=SystemManager.systemSetting.getWww() %>/resource/images/alipay_fastlogin.jpg" alt="支付宝快捷登录">
							</a>
						</span>
						<span style="display:none">
							<button type="button" class="btn btn-primary btn-sm" id="login-test">百度登录</button>
<!-- 							<a><img style="width: 100px;height: 25px;" src="http://www.baidu.com/img/bdlogo.gif">百度登录</a> -->
						</span>
		              </div>
	            </div>
			</div>
