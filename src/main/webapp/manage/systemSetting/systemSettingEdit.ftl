			...
			<table class="table table-bordered">
				<tr>
					<td colspan="2">
						...
						<input type="button" method="deleteImageByImgPaths" onclick="return deleteImageByImgPaths();"
...
<input value="${basepath}/index.jsp?style=" id="base_input" style="display: none;"/>
<script>
	var qqHelpHtml;
