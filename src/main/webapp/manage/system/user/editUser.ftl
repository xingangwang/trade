		...
		<table class="table table-bordered">
			...
			<tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left;"><input type="password" name="password" data-rule="密码:required;密码:password;length[6~20];"
                                                              id="password" />
            ...
            <#if !insertAction> <br>(不输入表示不修改密码)</#if>
                ...
                <tr>
                    ...
                    <td style="text-align: left;"><input type="password" name="newpassword2" data-rule="确认密码:required;确认密码:match(password)"
                                                              id="newpassword2" />
                    </td>
                </tr>
			<tr>
