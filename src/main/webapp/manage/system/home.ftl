        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                ...
                <table class="table table-bordered">
                    <tr>
                        <td>未付款订单数：<a class="font-focus" href="${basepath}/manage/order/selectList?init=y&paystatus=n">${systemManager().ordersReport.getNotPayCount()}</a></td>
                    ...
                    <tr>
                        <td>已取消订单数：<a class="font-focus" href="${basepath}/manage/order/selectList?init=y&status=CANCELLED">${systemManager().ordersReport.getCancelCount() }</a></td>
                        <td>等待发货订单数：<a class="font-focus" style="color: #f50;" href="${basepath}/manage/order/selectList?init=y&status=PAID">${systemManager().ordersReport.getWaitSendGoodsCount()}</a></td>
                    </tr>
                </table>
