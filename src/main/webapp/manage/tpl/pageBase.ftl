    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${basepath}/manage/user/home">选我吧后台管理系统</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li><a href="${basepath}/" target="_blank"><i class="glyphicon glyphicon-home"></i> 商城首页</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                        	<a href="${basepath}/manage/user/show?account=${currentUser().username}" target="_blank"><i class="fa fa-user fa-fw"></i> 用户信息</a>
                        </li>
                        <li>
