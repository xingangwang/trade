package net.jeeshop.core.framework.interceptor;
...
//
///**
// * 后台拦截器,负责对用户的登录、404,500，action异常等进行拦截处理。
...
//	public static final String login = "login";//转到登录页面
...
////			logger.error("不对用户登录进行拦截。不对加载权限资源进行拦截");
