package net.jeeshop.core.pay.alipay.util;
...
import net.jeeshop.core.pay.alipay.sign.MD5;
import net.jeeshop.core.pay.alipay.util.httpClient.HttpProtocolHandler;
import net.jeeshop.core.pay.alipay.util.httpClient.HttpRequest;
import net.jeeshop.core.pay.alipay.util.httpClient.HttpResponse;
import net.jeeshop.core.pay.alipay.util.httpClient.HttpResultType;
