...
public class FrontContainer {
	public static final String USER_INFO = "user_info";// 登录的用户信息
	//public static final String USER_INFO = Constants.SESSION_USER_KEY;
...
//	public static String show_user_option_error = "show_user_option_error";//显示用户操作错误信息，error.jsp页面会显示session中该key指定的错误信息，显示后会同时清除该错误信息。
	...
	public static final Object insert_outAccount_lock = new Object();//使用第三方信任登录，系统会为该信任登录在本地系统建立一个虚账户，此变量保证虚账号在本系统中建立的时候账号不重复。加锁！
